...
import { TestSignupForm } from "@/components/auth/test-signup-form";

export const dynamic = "force-dynamic";

export const metadata = {
  title: "Test Signup - VehicleClaim AI",
  description: "Create an account with email and password for testing purposes.",
};
